"""Exp 31 plots: recall and edge-count curves for four conditions on DEEP-96 cluster drift."""
...
COLORS = {
    ...
    "adaptive_targeted_cluster": "mediumpurple",
}
LABELS = {
    "static": "Static",
    "adaptive_eh": "Adaptive EH (conjugate)",
    "adaptive_layer0_eh": "Adaptive Layer0 EH (evict)",
    "adaptive_targeted_cluster": "Targeted cluster injection",
}
COND_ORDER = ["static", "adaptive_layer0_eh", "adaptive_eh", "adaptive_targeted_cluster"]
...
def plot_schedule(df, schedule, cfg, plots_dir):
    ...
    for cond in ["adaptive_eh", "adaptive_layer0_eh", "adaptive_targeted_cluster"]:
        if cond not in present:
            continue
