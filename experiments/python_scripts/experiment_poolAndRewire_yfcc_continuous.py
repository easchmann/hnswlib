# PoolAndRewire adaptation experiment on YFCC DINO embeddings with continuous drift.
#
...
#
# Usage:
#   python experiment_poolAndRewire_yfcc_continuous.py \
...
def main():
    ...
    print(f"YFCC poolAndRewire continuous-drift experiment")
    ...
    for ef in args.ef_sweep:
        idx = load_fresh(index_path, n_index_actual)
        warmup_q = query_sets[args.shift_sigmas[0]][:args.n_warmup]
        ...
        cumulative_query = 0
        print(f"\n  ef={ef}  (controller initialized on sigma={args.shift_sigmas[0]} warmup)")
        for sigma in args.shift_sigmas:
        ...
        n_eval_queries = len(args.shift_sigmas) * args.n_queries
