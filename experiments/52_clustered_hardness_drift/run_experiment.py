"""Experiment 52: static vs adaptive_current vs adaptive_improved on clustered structural hardness drift."""
...
def main():
    ...
    # Optional second positional arg: "gradual" or "sudden" to run a single schedule.
    # Enables parallel job-array execution without duplicating script logic.
